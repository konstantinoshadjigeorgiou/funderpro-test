              ...
              $href = "/"; ?>
                        ...
                        <a href="<?= $href; ?>" class="logo no-underline">
                            <img src="<?= get_stylesheet_directory_uri(); ?>/dist/images/logo.png"
                                alt="<?= bloginfo('name'); ?>">
                                <img class='more' src="<?= get_stylesheet_directory_uri(); ?>/dist/images/more.png"
                                alt="<?= bloginfo('name'); ?>">
                        </a>
              ...
              if (has_nav_menu('main')) : ?>
                        <div class="navbar-menu-wrapper">
                            <nav class="main-navigation nav-menu"
                                aria-label="<?php esc_attr_e('Main Menu', TEXT_DOMAIN); ?>">
                                <?php
                    wp_nav_menu(
                      array(
                        'theme_location' => 'main',
